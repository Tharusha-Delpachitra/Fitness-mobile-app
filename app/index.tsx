    ...
    <View className='flex-1 flex justify-end'>
        ...
        >
          ...
          <Animated.View entering={FadeInDown.delay(200).springify()}>
            <TouchableOpacity onPress={() => router.push('/home')} style={{height: hp(7), width: wp(80)}} className='mt-5 bg-rose-500 flex items-center justify-center mx-auto rounded-full border-[2px] border-white'>
